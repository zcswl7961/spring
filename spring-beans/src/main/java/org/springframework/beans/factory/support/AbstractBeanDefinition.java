...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	 ...
	 * <bean id="" factory-bean="" factory-method="" />
	 *
	 * factory-bean factory-method的用法：
	 ...
	 *     }
	 *     //对应静态的方法
	 *     public static Car staticCreateCar() {
	 *         Car car = new Car();
	 *         return car;
	 *     }
	 * }
	 * <bean id="carFactory" class = "com.uyun.test.CarFactory"></bean>
	 * <bean id="car" factory-bean="carFactory" factory-method="createCar"></bean> （1）
	 *
	 *
	 * 	<bean id="car1" class="com.baobaotao.ditype.CarFactory" factory-method = "staticCreateCar"></bean> (2)
	 *
	 * 	具体的使用{https://www.cnblogs.com/vickylinj/p/9474597.html}
	 *
	 *
	 */
	@Nullable
